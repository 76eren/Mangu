...
public class SplashScreen {
    static String[] statuses = {
            "Getting things ready, please be patient"
            ...
            , " What is taking so long? The app developer must be an idiot huh"
            , "Injecting malware... just kidding"
            , "You've been hit by a smooth criminal"
            , "Don't forget to take out the trash"
            , "Don't forget to water the crops"
            , "Don't forget to give the dog water"
            , "I have a gun"
            , "This is supposed to be a loading screen in case you didn't notice"
            , "Loading"
            , "Why is coming up quotes for a loading screen so hard?"
            , "Ew, cringeeee"
